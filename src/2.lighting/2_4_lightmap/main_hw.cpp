...
//shader文件路径
const char* LIGHTING_VS_SHADER_PATH = "../src/2_4_lightmap/shader/vert.vs";
const char* LIGHTING_FS_SHADER_PATH = "../src/2_4_lightmap/shader/frag.fs";
...
int main(){
    ...
    //纹理数据
    Texture2D diffuseMap("../texture/container2.png", Texture2DParameters(GL_RGBA, GL_RGBA, GL_REPEAT, GL_REPEAT, GL_LINEAR, GL_LINEAR, true));
    Texture2D specularMap("../texture/container2_specular.png", Texture2DParameters(GL_RGBA, GL_RGBA, GL_REPEAT, GL_REPEAT, GL_LINEAR, GL_LINEAR, true));
    Texture2D emissionMap("../texture/matrix.jpg", Texture2DParameters(GL_RGB, GL_RGB, GL_REPEAT, GL_REPEAT, GL_LINEAR, GL_LINEAR, true));

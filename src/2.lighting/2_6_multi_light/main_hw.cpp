...
//shader文件路径
const char* LIGHTING_VS_SHADER_PATH = "../src/2_6_multi_light/shader/vert.vs";
const char* LIGHTING_FS_SHADER_PATH = "../src/2_6_multi_light/shader/frag.fs";
...
int main(){
    ...
    for(unsigned int i = 0; i < 4; i++){
        pointLightParams.color = glm::vec3(0.0, 1.0f, 0.0f);
        pointLightParams.attenuationFactor1 = 1.0f;
        pointLightParams.attenuationFactor2 = 0.09f;
        pointLightParams.attenuationFactor3 = 0.032f;
        pointLightParams.position = pointLightPositions[i];

        PointLight* light = new PointLight(pointLightParams);
        pointLights[i] = light;
    ...
    spotLightParams.position = camera.position;
    spotLightParams.direction = camera.forward;
    spotLightParams.color = glm::vec3(1.0f, 1.0f, 1.0f);
    spotLightParams.cutoff = cos(glm::radians(6.25f));
    spotLightParams.outerCutoff = cos(glm::radians(8.75f));
    spotLightParams.attenuationFactor1 = 1.0f;
    spotLightParams.attenuationFactor2 = 0.09f;
    spotLightParams.attenuationFactor3 = 0.032f;

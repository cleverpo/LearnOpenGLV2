...
int main()
{
    ...
    // -------------------------
    Shader shader("../src/5_3_1_shadow_mapping/shader/shadow_mapping.vs", "../src/5_3_1_shadow_mapping/shader/shadow_mapping.fs");
    Shader simpleDepthShader("../src/5_3_1_shadow_mapping/shader/shadow_mapping_depth.vs", "../src/5_3_1_shadow_mapping/shader/shadow_mapping_depth.fs");
    Shader debugDepthQuad("../src/5_3_1_shadow_mapping/shader/debug_quad.vs", "../src/5_3_1_shadow_mapping/shader/debug_quad.fs");
...
void scroll_callback(GLFWwindow* window, double xoffset, double yoffset)
{
    camera.processScrollInput(static_cast<float>(yoffset));
}

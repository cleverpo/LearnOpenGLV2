...
int main(){
    ...
    //纹理
    Texture2D texture1("resources/texture/container.jpg", Texture2DParameters(GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR));
    Texture2D texture2("resources/texture/awesomeface.png", Texture2DParameters(GL_MIRRORED_REPEAT, GL_REPEAT, GL_LINEAR, GL_LINEAR));
